...
class Generator:
    ...
    def generate_password(m):
        ...
        lst = ('0123456789①②③④⑤⑥⑦⑧⑨⑩❶❷❸❹❺❻❼❽❾❿⑴⑵⑶⑷⑸⑹⑺⑻⑼⑽⑾⑿⒀⒁⒂⒃⒄⒅⒆⒇½¼⅕¾⅛⅜⅝⅞⅓⅔⅖⅗⅘⅙⅚ⅠⅡⅢⅣⅤⅥⅦⅧⅨⅩⅪⅫ'
               ...
               'נסעףפץצקרשת'
               'װױײ׳״׵'									
               'ﬠﬡﬢﬣﬤﬥﬦﬧﬨ﬩שׁשׂשּׁשּׂאַאָ'
               'אּבּגּדּהּוּזּטּיּךּכּלּמּ'	
               'נּסּףּפּצּקּרּשּתּוֹבֿכֿפֿﭏ'
               '(* ^ ω ^) (´ ∀ *) (o^▽^o) (⌒▽⌒)☆ ヽ(・∀・)ﾉ (´｡• ω •｡) (o･ω･o) (＠＾◡＾)'
               '(^人^) (o´▽o) ( ´ ω ) (((o(*°▽°*)o))) (´• ω •) (＾▽＾) ╰(▔∀▔)╯ (─‿‿─) (✯◡✯) (◕‿◕)'
               '(⌒‿⌒) ＼(≧▽≦)／ (*°▽°*) ٩(｡•́‿•̀｡)۶ (´｡• ᵕ •｡) ( ´ ▽ ) ヽ(>∀<☆)ノ o(≧▽≦)o ＼(￣▽￣)／'
               '(*¯︶¯*) (o˘◡˘o) \(★ω★)/ (╯✧▽✧)╯ o(>ω<)o ( ‾́ ◡ ‾́ ) (ﾉ´ヮ)ﾉ*: ･ﾟ (๑˘︶˘๑)'
               '( ˙꒳​˙ ) (´･ᴗ･ ) (ﾉ◕ヮ◕)ﾉ*:･ﾟ✧(─‿‿─)♡ (´｡• ᵕ •｡) ♡ (´ ω ♡) ♡( ◡‿◡ ) (ღ˘⌣˘ღ) (♡°▽°♡) (´• ω •) ♡ (´ ε )♡ ╰(*´︶*)╯♡ '
               '(*˘︶˘*).｡.:*♡ (≧◡≦) ♡ (⌒▽⌒)♡ ♡ (˘▽˘>ԅ( ˘⌣˘) ( ˘⌣˘)♡(˘⌣˘ ) σ(≧ε≦σ) ♡ ♡ (⇀ 3 ↼) (˘∀˘)/(μ‿μ) ❤ ❤ (ɔˆз(ˆ⌣ˆc)'
               '(；⌣̀_⌣́) ☆ｏ(＞＜；)○ (￣ ￣|||) (；￣Д￣) (￣□￣」) (＃￣0￣) (＃￣ω￣) (￢_￢;) (＞ｍ＜) (」°ロ°)」'
               '╮( ˘ ､ ˘ )╭ ヽ(ー_ー )ノ ヽ(´ー )┌ ┐(‘～ )┌ ヽ(　￣д￣)ノ ┐(￣ヘ￣)┌ ヽ(￣～￣　)ノ ╮(￣_￣)╭'
               '(￣▽￣)ノ (*・ω・)ﾉ (°▽°)/ ( ´ ∀ )ﾉ (^-^*)/ (＠´ー)ﾉﾞ (´• ω •)ﾉ ( ° ∀ ° )ﾉﾞ'
               '(^_~) ( ﾟｏ⌒) (^_-)≡☆ (^ω~) (>ω^) (~人^) (^_-) ( -_・) ‿︵‿ヽ(°□° )ノ︵‿︵'
               '┬┴┬┴┤(･_├┬┴┬┴  ┬┴┬┴┤( ͡° ͜ʖ├┬┴┬┴  ヾ( ー´)シφ__  ∪＾ェ＾∪ ∪･ω･∪ ∪￣-￣∪ ∪･ｪ･∪ Ｕ^皿^Ｕ ＵＴｪＴＵ U^ｪ^U V●ᴥ●V ∪◣_◢∪ (▽◕ ᴥ ◕▽)'
               '/╲/\( •̀ ω •́ )/\╱\ /╲/\╭(ఠఠ益ఠఠ)╮/\╱\ /╲/\╭(ರರ⌓ರರ)╮/\╱\ /╲/\╭༼ ººل͟ºº ༽╮/\╱\ /╲/\╭( ͡°͡° ͜ʖ ͡°͡°)╮/\╱\ /╲/\╭[ ᴼᴼ ౪ ᴼᴼ]╮/\╱\ /╲/\╭[☉﹏☉]╮/\╱\ ଘ(੭ˊ꒳​ˋ)੭✧'
               '( ・・)つ―{}@{}@{}-  (*´з)口ﾟ｡ﾟ口(・∀・ ) (ﾒ￣▽￣)︻┳═一 (☆ω☆) ٩(◕‿◕)۶ (´ω｀) (´｡• ᵕ •｡) (´ ▽) (￣▽￣) (⌒ω⌒) ヽ(・ω・)ﾉ (≧ω≦) ＼(≧▽≦)／ '
               '╰(▔∀▔)╯ (¯︶¯) (＾▽＾) (✯◡✯) ＼(＾▽＾)／ (◕‿◕) ｡ﾟ(ﾟ^∀^ﾟ)ﾟ｡ ヽ(>∀<☆)ノ (´▽*) ⌒(o＾▽＾o)ノ (o´▽o) ＼(￣▽￣)／ ヽ(⌒▽⌒)ﾉ ∑d (ﾟ∀ﾟd) o (≧▽≦)o (ﾟ▽ﾟ) (≧◡≦)'
               '(⌒‿⌒) (＠＾－＾) (っ˘ω˘ς) <(￣︶￣)> (⌒―⌒) (-‿‿-) ヽ(・∀・)ﾉ (´｡• ω •｡) ヽ(o^―^o)ﾉ (o˘◡˘o) (─‿‿─) (*^‿^*) (o^▽^o) ╰(*´︶)╯ (((o (ﾟ▽ﾟ*)o))) (^人^) (⌒▽⌒)☆'
               '☺ ☻ ☹ シ ツ ʕʘ‿ಠʔ ￣ヘ¯ ◔◡‿◡◔ ⊙_ರೃ (͡๏̯͡๏)'
               '流行複選標記星星雪花電話電子郵件辦公室撲克牌和棋子的套裝箭十字架花卉拉丁字母圍成一圈幾何形狀奇怪的圖案阿拉伯和羅馬數字十二生肖心基於字母的字符性別占星術音樂手指地方其他'
               '← ↑ → ↓ ↔ ↕ ⇐ ⇒'
               '♈♉♊♋♌♍♎♏♐♑♒♓'
               '☀☁☂☃☼☽★☆☾℃℉ﻩﻩﻩ*ﻩ*ﻩ*ﻩﻩﻩ☀-‘๑’-☁ϟ☂︸☃⁂☼☽☾✩✪✫✬✭✮✯✰҈҉ʘ♂♁♀☿♃♄♅♆♇'
               '♔♕♖♗♘♙♙♚♛♜♝♞♟'
               ...
               '●•❍ø■▪▫□❏▄▀▄▀▄◘◆◇▀▄▀▄▀▄◢◣◤◥【】〖〗〘〙〔〕☯☮✇☭☄☣☢☸☠☪۞✡⌘☤☬☫〄※⊕⊗Ⓐ®©™⚠�۩￥￡'
               '￦$€₵₠₢₡₱₮₦₳♲♳♴♵♶♷♸♹♺♻♼♽✆☎☏✈✐✑✒✂✉✔✓✕✖✗✘☐☑☒□▣▤▥▦▧▨▩๑ஐॐ๖ۣۜGஇഊ₪₪§ѾΩ'
               'ѼఞಊఎയﻸֆൠƸ̴Ӂ̴Ʒஔ६३१२५७९ণঐঙৡ১২৩৯৶৸ઈઉ૬୭ໂໃໄ⌇༼ ༽Ҩҩ√∫∂∑∏−±×÷≈∝≡≠≤≥∈∩∪⊂⊃⊆⊇¬∧∨∃∀°′″∞‰∛∜ᴥ❛❜❝❞'
               '▲△▶▷▼∇▽◀◁⊲⊳⌫⌧⌦➢➣➤⋞⋟⋨⋩⋪⋫⋬⋭≪≫⋖⋗↔↕←↖↑↗→↘↓↙⇦⇧⇨⇩⇐⇑⇒⇓⇔⇕⇖⇗⇘⇙⇚⇛⇄⇅⇆⇇⇈⇉⇊↰↱↲↳↴↵↶↷➜➡➨☇⃔⃕↜↝↫↬↺↻➛➠➻➲￩￫➴➶'
               '✗✘✙✚✛✜✝†✞✟✠✡✕✖✣✤✥❖✦✧‡☩☥☦☨⌖༒༓✱✲✳✴✵✶✷✸✹✺✻✼✽✾✿❀❁❂❃❊❄❅❆❇❈❉❊❋'
               'ソッヅツゾシジټ˜”*°•.•°*”˜.•°*”˜ ˜”*°•.•° *”˜˜”*°•.•°*”˜˜”*°•♥●•٠٠•●♥°*”˜˜”*°•☎✿₪▲=:^_^:='
               'ء ي ڴ ک م ن و ۇ ه ل ر ز س ش غ ق ی گ ب پ ت ث ج چ د ܓ ا'
               'ԱաԲբԳգԴդԵեԶզԷէԸըԹթԺժԻիԼլԽխԾծԿկՀհՁձՂղՃճՄմՅյՆնՇշՈոՉչՊպՋջՌռՍսՎվՏտՐրՑցՒւՓփՔքՕօՖֆ'
               'აბგდევზჱთიკლმნჲოპჟრსტუჳფქღყშჩცძწჭხჴჯჰჵ'
               'א ב ג ד ה ו ז ח ט י כ (ך) ל מ (ם) נ (ן) ס ע פ (ף) צ (ץ) ק ר ש ת'
               'АБВГҐДЂЃЕ(Ѐ)ЁЄЖЗ(Ζ)ЅИ(Ѝ)ІЇЙЈКЛЉМНЊОПРСТЋЌУЎФХЦЧЏШЩЪЫЬЭЮ'
               '(Ҁ)(Ѹ)Ѡ(Ѿ)(Ѻ)ѢAѤІѢѦѪѨѬѮѰѲѴ(Ѷ)'
               'ӐӒӘӚӔҒӶҔӖҼҾӁҖӜҘӞӠӤӢӀҊҚҞҠӃҜӅӍҤҢӉӇӦӨӪҨҦҎҪҬӲӰӮҮҰҲҺҴӴҶӋҸӸҌӬ'
               '¿¡˙‘ʁoєq|qqmmҺцхфʎʟɔduонwvʞņnɛжǝǝ6ɹʚ9ɐzʎxʍʌnʇsɹbdouɯlʞɾıɥƃɟǝpɔqɐ'
               '∅⊕⊖⊗⊘⊙⊚⊛⊜⊝╭╮╯╰⌒⌢⌣◜◝◞◟◠◡○❍◌◍◎●◐◑◒◓◔◕◖◗☉'
               '▁▂▃▄▅▆▇█▉▊▋▌▍▎▏▐░▒▓▀▕■□▢▣▤▥▦▧▨▩▪▫▬▭▮▯▰▱◘◙◚◛◧◨◩◪◫◆◇◈◊'
               '∟∠∡∢∆∇⊲⊳⊴⊵⋈⋉⋊⋋⋌⍢▲△▴▵▶▷▸▹►▻▼▽▾▿◀◁◂◃◄◅✖'
               '‖∣∤∥∦‗▔▕─━│┃┄┅┆┇┈┉┊┋╌╍╎╏╱╲╳╴╵╶╷╸╹╺╻╼|‑‒–—―†‡'
               ...
               '‰‱∀∁∂∃∄∅∆∇∈∉∊∋∌∍∎%∏∐∑−∓∔∕∖∗∘∙√∛∜∝∞∟∠∡∢∣∤∥∦∧∨∩∪ƒ∫∬∭∮∯∰∱∲∳∴∵∶∷∸∹∺∻∼∽∾∿≀≁≂≃≄≅≆≇≈≉≊≋≌≍≎≏≐≑≒≓≔≕≖≗≘≙≚≛≜≝≞≟≠≡≢≣≤≥≦≧≨≩≪≫'
               '≬≭≮≯≰≱≲≳≴≵≶≷≸≹≺≻≼≽≾≿⊀⊁⊂⊃⊄⊅⊆⊇⊈⊉⊊⊋⊌⊍⊎⊏⊐⊑⊒⊓⊔⊕⊖⊗⊘⊙⊚⊛⊜⊝⊞⊟⊠⊡⊢⊣⊤⊥⊦⊧⊨⊩⊪⊫⊬⊭⊮⊯⊰⊱⊲⊳⊴⊵⊶⊷⊸⊹⊺⊼⊽⊾⊿⋀⋁⋂⋃⋄⋅⋆⋇⋈⋉⋊⋋⋌⋍⋎⋏⋐⋑⋒⋓⋔⋖⋗⋘⋙⋚⋛⋜⋝⋞⋟⋠⋡⋢⋣⋤⋥⋦⋧⋨⋩⋪⋫⋬⋭⋮⋯⋰⋱'
               '‹ˆ›ʹʺʻʼʽʾʿˀˁ˂˃˄˅ˆˇˈˉˊˋˌˍˎˏːˑ˒˓˔˕˖˗˘˙˚˛˝˞˟ˠˡˢˣˤ˥˦˧˨˩־ֿ ׀ׂ ׃‚„…‘’"”•§¨«»¬¶·¸–—˜ !"&'
               '()*,—./‐‑‒–—―‖‗‘’‚‛"”„‟†‡•‣․‥…‧ ′″‴‵‶‷‸‹›※‼‽‾⁀⁁⁂⁃⁄˫ˬ˭ˮ˯˰˱˲˳˴˵˶˷˸˹˺˻˼˽˾˿︰︱︲︳︴︵︶︷︸︹︺︻︼︽︾︿﹀﹁﹂﹃﹄﹉﹊﹋﹌﹍﹎﹏'
               "┬──┬ ノ( ゜-゜ノ)(ノಠ益ಠ)ノ彡┻━┻♪└|∵|┐♪└|∵|┘♪┌|∵|┘♪＼(▽￣＼(￣▽￣)／￣▽)／̳̿В̳̿|]—[''''I''''I''''I''''I'''']>——–█████[][][][][]50%*̡͌l̡*̴̡̡̡ı̴̴̡̡̡_|̲̲̲͡͡͡▫̲͡ ̲̲̲͡͡π̲̲͡͡ヾ(⌐■_■)ノ"
               'AaᎯ凡Ꮨ∀₳ǺǻαάΆẫẮắẰằẳẴẵÄªäÅÀÁÂåãâàáÃᵰ'
               'BbℬᏰβ฿ßЂƁƀხ方␢Ꮄ'
               'CcℭℂÇ¢çČċĊĉςĈćĆčḈḉ⊂Ꮸ₡¢'
               'DdƊĎďĐđð∂₫ȡ'
               'Eeℯ£Ē℮ēĖėĘěĚęΈêξÊÈ€É∑ẾỀỂỄéèعЄєέε'
               'Ffℱ₣ƒ∮Ḟḟჶᶂφ╒'
               'GgᏩᎶℊǤǥĜĝĞğĠġĢģפᶃ₲'
               'HhℍℋℎℌℏዙᏥĤĦħΉ廾ЋђḨҺḩ'
               'IiℐℑίιÏΊÎìÌíÍîϊΐĨĩĪīĬĭİįĮᎥ'
               'JjჟĴĵᶖɉ'
               'Kk₭ᏦЌkќķĶҜҝﻸᶄ'
               'LlℒℓĿŀ£ĹĺĻļλ₤ŁłľĽḼḽȴᏝ￡Ꮑ'
               'Mmℳ ʍ ᶆ Ḿ ḿ 爪 ₥'
               'NnℕηñחÑήŋŊŃńŅņŇňŉȵℵ₦'
               'Ooℴტ٥ΌóόσǿǾΘòÓÒÔôÖöÕõờớọỌợỢøØΌỞỜỚỔổỢŌō'
               'Ppℙ℘þÞρᎮᎵ尸Ҏҏᶈ₱קァ'
               'QqℚqQᶐǬǭჹ'
               'Rrℝℜℛ℟ჩřŘŗŖŕŔᶉᏒ尺'
               'SsᏕṦṧȿى§ŚśšŠşŞŝŜ₰∫$ֆ'
               'Tt₸†TtτΐŢţŤťŧŦィ干ṪṫナᎿᏆテ₮'
               'Uu∪Ũ⋒ỦỪỬỮỰύϋÙúÚΰùÛûÜửữựЏüừŨũŪūŬŭųŲűŰůŮ'
               'Vv∨√ᏉṼṽᶌ\/℣ʋ'
               'Ww₩ẃẂẁẀẅώωŵŴᏔᎳฬẄѡᏊᏇผฝพฟ'
               'Xxχ×ჯẌẍᶍ'
               'YyɣᎩᎽẎẏϒɤ￥り'
               'Zzℤℨჳ乙ẐẑɀᏃ'
               '.'
...
class MainProgramm(Generator):

    def __init__(self, e, j, p):
        self.t = e
        self.y = j
        self.u = p
    ...
    def main(n, m):
        ...
        for i in range(int(n ** 0.05)):
            if i != 0:
                while h in k:
                    h = Generator.generate_password(m)
                k.append(h)
            else:
                h = Generator.generate_password(m)
                k.append(h)
    ...
    password_mini = {
        ...
        'Мини-пароль': Generator.generate_password(10000000000000)
        
            }

    password_max = {
        
        'Большой_пароль': main(999999999999999999999999999999999999999, 100000000)

            }

    for key, value in password_mini.items():
        f.write("{0} \n \n \n {1} \n \n \n ".format(key, value))

    for key in password_max.keys():
        f.write("{0} \n \n \n".format(key))

    for value in password_max.values():
        f.write("{0}".format(value)[1:-2])
...
class MainWindow(QMainWindow):
    ...
    def update_title(self):
        self.setWindowTitle("%s - Pro_Password_Generator" % (os.path.basename(self.path) if self.path else "Password_1"))
...
if __name__ == '__main__':
    ...
    app.setApplicationName("Pro_Password_Generator")
